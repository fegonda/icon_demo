...
sys.path.insert(4,os.path.join(base_path, '../../common'))
...
if __name__ == '__main__':
    ...
    path = '%s/%s'%(Paths.TrainGrayscale, 'ac3_input_0003.tif')
    ...
    classifier = CNN(	input=x, 
			...
			train_time=10,
			id='testcnn',
			path='/n/home00/fgonda/icon/data/models/best_testcnn.cnn.pkl')
    ...
    for fragment in fragments:
        hidden_out = get_hidden_output(image_shared=fragment, hiddenLayer=classifier.mlp.hiddenLayers[0], nHidden=200, nfilt=classifier.nkernels[-1])
    ...
    prob_img = shift(prob_img,(5,5) #32,32))
